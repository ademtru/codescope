      ...
      <header className="bg-gh-header border-b border-gh-border">
        <div className="max-w-[1280px] mx-auto px-4 lg:px-6 h-16 flex items-center">
          <div className="flex items-center gap-3">
            <svg width="32" height="32" viewBox="0 0 32 32" className="text-gh-fg-onEmphasis" fill="none">
              ...
              <path d="M11 10.5L8.5 14L11 17.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M17 10.5L19.5 14L17 17.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
